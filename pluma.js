function pluma(scaleX, scaleY, scaleZ){
	...
	this.draw = function(modelMatrix, gl, shaderProgram){
	    ...
	    this.contrapeso.drawEspecial(matrix_contrapeso, gl, shaderProgram);
	    ...
	    this.barraDerecha.drawEspecial(matrix_barraDerecha, gl, shaderProgram);
	    ...
	    this.barraIzquierda.drawEspecial(matrix_barraIzquierda, gl, shaderProgram);
