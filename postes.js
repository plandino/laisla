function postes(){
	...
	this.draw = function(modelMatrix, gl, shaderProgramSimple, shaderProgramReflection, shaderProgramSoloTexturas){
	    ...
	    this.posteUno.drawConTextura(matrix_posteUno, gl, shaderProgramReflection, KA, KD, 0.3, S, shaderProgramSoloTexturas, null);
	    ...
	    this.posteDos.drawConTextura(matrix_posteDos, gl, shaderProgramReflection, KA, KD, 0.3, S, shaderProgramSoloTexturas, null);
