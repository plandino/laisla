function pataGrua(scaleX, scaleY, scaleZ){
	...
	this.initBuffers = function(gl, shaderProgram){
	    ...
	    this.ruedaUno = new extrusion(forma, camino, escala, tangentes, normales, false, true);
	    ...
	    this.ruedaDos = new extrusion(forma, camino, escala, tangentes, normales, false, true);
	    this.ruedaUno.agregarTapa(0, false, true, null, 10, 10);
	    this.ruedaUno.agregarTapa(camino.length-1, true, true, null, 10, 10);
	    this.ruedaUno.initBuffers(gl, shaderProgram, "green");
	}
	...
	this.draw = function(modelMatrix, gl, shaderProgramRelieve, shaderProgramSimple){
	    ...
	    this.pataUno.draw(matrix_pataUno, gl, shaderProgramRelieve);
	    ...
	    this.pataDos.draw(matrix_pataDos, gl, shaderProgramRelieve);
	    ...
	    this.barraCruzadaAbajoGrua.draw(matrix_barraCruzadaAbajoGrua, gl, shaderProgramRelieve);
	    ...
	    this.barraCruzadaArribaGrua.draw(matrix_barraCruzadaArribaGrua, gl, shaderProgramRelieve);
	    ...
	    this.barraDiagonalGrua.draw(matrix_barraDiagonalGrua, gl, shaderProgramRelieve);
