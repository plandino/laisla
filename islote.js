function islote(scaleX, scaleY, scaleZ){
    ...
    this._cargarForma = function(){
    	...
    	var tramos = [];
    	tramos.push(new curvaBSpline(P[0], P[1], P[2], P[3], 	2*n));
    	tramos.push(new curvaBSpline(P[3], P[4], P[5], P[6], 	2*n));
    	tramos.push(new curvaBSpline(P[6], P[7], P[8], P[9], 	n));
    	tramos.push(new curvaBSpline(P[9], P[10], P[11], P[12], 	n));
    	tramos.push(new curvaBSpline(P[12], P[13], P[14], P[15],	n));
    	tramos.push(new curvaBSpline(P[15], P[16], P[17], P[18],	n));
    	tramos.push(new curvaBSpline(P[18], P[19], P[20], P[0], 	n));
